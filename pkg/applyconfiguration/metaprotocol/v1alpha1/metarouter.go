...
// MetaRouterApplyConfiguration represents an declarative configuration of the MetaRouter type for use
// with apply.
type MetaRouterApplyConfiguration struct {
	v1.TypeMetaApplyConfiguration    `json:",inline"`
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *v1alpha1.MetaRouter      `json:"spec,omitempty"`
	Status                           *metav1alpha1.IstioStatus `json:"status,omitempty"`
}

// MetaRouter constructs an declarative configuration of the MetaRouter type for use with
// apply.
func MetaRouter(name, namespace string) *MetaRouterApplyConfiguration {
	b := &MetaRouterApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("MetaRouter")
...
func (b *MetaRouterApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
