...
// RedisServiceApplyConfiguration represents an declarative configuration of the RedisService type for use
// with apply.
type RedisServiceApplyConfiguration struct {
	v1.TypeMetaApplyConfiguration    `json:",inline"`
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *v1alpha1.RedisService    `json:"spec,omitempty"`
	Status                           *metav1alpha1.IstioStatus `json:"status,omitempty"`
}

// RedisService constructs an declarative configuration of the RedisService type for use with
// apply.
func RedisService(name, namespace string) *RedisServiceApplyConfiguration {
	b := &RedisServiceApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("RedisService")
...
func (b *RedisServiceApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
