...
func (c *FakeMetaRouters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(metaroutersResource, c.ns, name, opts), &v1alpha1.MetaRouter{})
...
func (c *FakeMetaRouters) Apply(ctx context.Context, metaRouter *metaprotocolv1alpha1.MetaRouterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.MetaRouter, err error) {
	if metaRouter == nil {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(metaroutersResource, c.ns, *name, types.ApplyPatchType, data), &v1alpha1.MetaRouter{})
...
func (c *FakeMetaRouters) ApplyStatus(ctx context.Context, metaRouter *metaprotocolv1alpha1.MetaRouterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.MetaRouter, err error) {
	if metaRouter == nil {
		return nil, fmt.Errorf("metaRouter provided to Apply must not be nil")
	}
	data, err := json.Marshal(metaRouter)
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(metaroutersResource, c.ns, *name, types.ApplyPatchType, data, "status"), &v1alpha1.MetaRouter{})
